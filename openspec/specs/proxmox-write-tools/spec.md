# proxmox-write-tools Specification

## Purpose

Mutating MCP tools for Proxmox VE: guest lifecycle, snapshots and guest management operations. These tools are gated behind an explicit write-enable flag and reuse the client's error and validation behavior.
